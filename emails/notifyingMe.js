...
function emailNotifyingMe (user) {
...
<![endif]-->
  ...
  <title></title>
    ...
    <style type="text/css">
      table, td { color: #000000; } a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_menu_1 .v-padding { padding: 5px 15px !important; } }
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="font-size: 26px; line-height: 36.4px;"><strong><span style="color: rgb(80,29,89); line-height: 36.4px; font-family: 'times new roman', times; font-size: 26px;"><span style="line-height: 36.4px; font-size: 26px;">Order Confirmation</span></span></strong></span></p>
  </div>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="line-height: 160%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 160%; text-align: center;"><span style="font-size: 18px; line-height: 28.8px; color: #474747;"><strong>Hey ${user.name},</strong></span><br /><span style="font-size: 18px; line-height: 28.8px; color: #545454;"><strong>Thank you for your order!</strong></span><br /><span style="font-size: 18px; line-height: 28.8px; color: #545454;"><strong>We'll drop you another email when we ship your items</strong></span></p>
  </div>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="color: rgb(250,203,82); font-size: 14px; line-height: 19.6px;"><strong><span style="font-size: 18px; line-height: 25.2px;">ITEMS ORDERED</span></strong></span></p>
  </div>
...
${user.finishedOrder.items.map(item => {
  ...
  <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    <tbody>
      <tr>
        <td style="overflow-wrap:break-word;word-break:break-word;padding:50px 20px;font-family:arial,helvetica,sans-serif;" align="left">
          
    <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;"><strong><span style="color: #545454; line-height: 22.4px; font-size: 16px;">${item.name}&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;${item.chosenQuantity}x &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;£${item.price}</span></strong></span></p>
  <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;"><strong><span style="color: rgb(82,193,199); line-height: 22.4px; font-size: 14px;">${item.chosenColor}</span></strong></span></p>
  <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;"><strong><span style="color: rgb(82,193,199); line-height: 22.4px; font-size: 14px;">${item.chosenSize}</span></strong></span></p>
    </div>
